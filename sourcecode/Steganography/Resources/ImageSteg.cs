    ...
    public partial class Form1 : Form
    {
        ...
        private void buttonBrowseSecret_Click(object sender, EventArgs e)
        {
            ...
            if (ofd.ShowDialog() == DialogResult.OK)
            {
                ...
                pictureBoxSecret.Image = img;
                pictureBoxSecret.Image.Save(@"E:\ki.jpg", ImageFormat.Jpeg);
        ...
        {
            pictureBoxSimple.Image = Image.FromFile("E:\\SecretKey.jpeg");
            groupBoxDecryption.Visible = false;
            groupBoxEncryption.Visible = true;
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < EncryptedImage.Height; i++)
            {
                for (int j = 0; j < EncryptedImage.Width; j++)
                {
                   ...
                   // MessageBox.Show(newGrey.ToString());
                    ...
                    pixelToDecrypt = Color.FromArgb(newGrey,newGrey, newGrey, newGrey);
         ...
         //       richTextBox2.Text += "\n";
           ...
           // pictureBoxExtractedImage.Image = hiddenImage;
            pictureBoxExtractedImage.Image = Image.FromFile(@"E:\ki.jpg");
        ...
        private void textBoxDekey_Validating(object sender, CancelEventArgs e)
        {
            if (FormMain.seckey  == textBoxDekey.Text)
            {
            ...
            {
                MessageBox.Show(" Sorry Key is Mismatch");
                textBoxDekey.Text = "";
                textBoxDekey.Focus();
